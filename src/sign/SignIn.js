import { Chat, Facebook, LockOpenOutlined, LockOutlined, Mail, MailOutlined, MailRounded } from '@material-ui/icons';
            ...
            <Deskvers>
                <Backver>
                    ...
                    <Textcontent>
                        ...
                        <Link to='/signup'><h3>Sign in to continue to account</h3></Link>
                    </Textcontent>
                </Backver>
            </Deskvers>
            <Mobilevers>
                <Google>
                    <Button>
                        <Mail style={{marginRight:'10px'}}/>Continue with Google
                    </Button>
                    <Button>
                        <Facebook style={{marginRight:'10px'}}/>Continue with Facebook
                    </Button>
                </Google>
                <Ortag>Or</Ortag>
                <Form>
                    ...
                    <Formcontent>
                        ...
                        <span style={{textAlign:'right',marginBottom:'10px'}}>Forgot Password?</span>           
                        <Link to='/home'><Signin>Sign In</Signin></Link>
                        <p>No account yet? <Link to='/signup'><span>Sign Up</span></Link></p>
                </Form>
            </Mobilevers>
        </SigninWrap>   
    </Layout>
